...
#define SR_SER 13                  // Serial Data Input (Pin 14 on 74HC595)
#define SR_SRCLK 44                // Shift Register Clock (Pin 11 on 74HC595)
#define SR_RCLK 43                 // Storage Register Clock (Pin 12 on 74HC595)
...
void PI_ALGO() {
  ...
  if (temperature <= 8.1 && PI_STATE == 1) {
    ...
    HS_dutyCycle = map_algo(temperature, 2, 5, 0, 5000);               // Scale 12-bit resolution (0-4095)
